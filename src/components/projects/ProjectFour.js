			...
			<div>
				<ReactCardFlip isFlipped={isFlipped} flipDirection='vertical'>
					...
					<div className='projectFour pmpBack'>
						<a
							href='https://practice-makes-permanent.netlify.app/'
							target='_blank'
							rel='noreferrer'
							className='pmpDeployed'>
							Deployed Site
						</a>
						<br />
						<div className='pmpGitHubContainer'>
							<a
								href='https://github.com/AshveerB/practice-makes-permanent'
								target='_blank'
								rel='noreferrer'
								className='pmpGitHub'>
								Front End
								...
								<img
									src={GitHubLogo}
									alt='gitHubLogo'
									className='pmpGitHubLogo'></img>
							</a>
							<br />
							<a
								href='https://github.com/AshveerB/practice-makes-permanent-back-end'
								target='_blank'
								rel='noreferrer'
								className='pmpGitHub'>
								Back End
